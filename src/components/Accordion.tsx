          ...
          <table className="w-full text-sm">
            <thead className="border-b border-gray-200 sticky top-10 bg-white">
              <tr className="text-left">
                ...
                <th className="pb-3 font-medium text-gray-600">Workspace Name</th>
                <th className="pb-3 font-medium text-gray-600">Report Name</th>
                <th className="pb-3 font-medium text-gray-600">Ext_Widget_Count</th>
